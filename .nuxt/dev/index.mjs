...
import { getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/vue/index.mjs';
import { walkResolver } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/unhead/dist/utils.mjs';
import { renderToString } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/vue/server-renderer/index.mjs';
import { createHooks } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/node-mock-http/dist/index.mjs';
import { klona } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/unctx/dist/index.mjs';
import { digest, hash as hash$1 } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/ohash/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/errx/dist/index.js';
import devalue from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { basename, isAbsolute } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Volumes/SN770/Study/Node-Bird/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/ipx/dist/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Volumes/SN770/Study/Node-Bird/node_modules/unhead/dist/plugins.mjs';
...
const _oiyVP6uqqgmb6zvxrx1UBUFsNwduVIXYbFmxMRdBYc = (nitroApp) => {
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Volumes/SN770/Study/Node-Bird/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Volumes/SN770/Study/Node-Bird/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/SN770/Study/Node-Bird","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/SN770/Study/Node-Bird/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/SN770/Study/Node-Bird/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/SN770/Study/Node-Bird/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Volumes/SN770/Study/Node-Bird/.data/kv"}));
...
const _w6XNDKUppsiSpprgqjo37Ar2C3nSpa5N2vgCO2gEy1w = defineNitroPlugin(async (nitroApp) => {
...
const _xIIL8GxrX8f22E7v12i9cuUo83bLF9TLT6qZPndxSc = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _UrWrnDvh2_8maZBbuByZOEuaQHdyIgH30BuM7AA38Vk,
_oiyVP6uqqgmb6zvxrx1UBUFsNwduVIXYbFmxMRdBYc,
_w6XNDKUppsiSpprgqjo37Ar2C3nSpa5N2vgCO2gEy1w,
_xIIL8GxrX8f22E7v12i9cuUo83bLF9TLT6qZPndxSc
];

const warnOnceSet = /* @__PURE__ */ new Set();
const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _5GgTVN = defineCachedEventHandler(async (event) => {
...
const _AhBsrq = defineEventHandler(async (e) => {
...
const _ZQqBuh = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _oputxt = defineEventHandler(async (e) => {
...
const _FGTujh = defineEventHandler(async (e) => {
...
const __TTbya = defineEventHandler(async (e) => {
...
const _19Tfi9 = defineEventHandler(async (e) => {
  const nitro = useNitroApp();
...
const _080FFF = defineEventHandler(async (e) => {
...
const _0edL9R = defineEventHandler(async (e) => {
...
const _rVBM9k = defineEventHandler(async (e) => {
...
const _jprFrj = lazyEventHandler(() => {
...
const _lazy_OmOnlz = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_OmOnlz, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _5GgTVN, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _AhBsrq, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _ZQqBuh, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _oputxt, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _FGTujh, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: __TTbya, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _19Tfi9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _080FFF, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _0edL9R, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _rVBM9k, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _jprFrj, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_OmOnlz, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_OmOnlz, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Volumes/SN770/Study/Node-Bird/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Volumes/SN770/Study/Node-Bird/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
